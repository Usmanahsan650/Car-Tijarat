            ...
            <Row>
                ...
                <Col>
                    <ListGroup>
                        ...
                        <ListGroup.Item>License Number Verified : <span className="fw-bold">{data.IsLicenseVerfied?<Badge bg="success">Yes</Badge>:<Badge bg="danger">NO</Badge>}</span></ListGroup.Item>
